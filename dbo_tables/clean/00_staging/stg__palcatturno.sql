with stg_palcatturno as (
	select
		--{{ dbt_utils.generate_surrogate_key(['col_pk1', 'col_pk2']) }} as pk_palcatturno,
	...
	from {{source('src_prod_kraken_abt','PALSch_PalCatTurno')}}
)
select * from stg_palcatturno