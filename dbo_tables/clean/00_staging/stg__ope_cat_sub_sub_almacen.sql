with stg_opecatsubsubalmacen as (
	select
		--{{ dbt_utils.generate_surrogate_key(['col_pk1', 'col_pk2']) }} as pk_opecatsubsubalmacen,
	...
	from {{source('src_prod_kraken_abt','dbo_OpeCatSubSubAlmacen')}}
)
select * from stg_opecatsubsubalmacen