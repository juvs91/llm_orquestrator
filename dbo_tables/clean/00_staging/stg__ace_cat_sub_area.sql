with stg_acecatsubarea as (
	select
		--{{ dbt_utils.generate_surrogate_key(['col_pk1', 'col_pk2']) }} as pk_acecatsubarea,
	...
	from {{source('src_prod_kraken_abt','dbo_AceCatSubArea')}}
)
select * from stg_acecatsubarea