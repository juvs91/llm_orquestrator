with stg_invcatalmacen as (
	select
		--{{ dbt_utils.generate_surrogate_key(['col_pk1', 'col_pk2']) }} as pk_invcatalmacen,
	...
	from {{source('src_prod_kraken_abt','dbo_InvCatAlmacen')}}
)
select * from stg_invcatalmacen